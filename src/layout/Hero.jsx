...
const Hero = () => {
    return (
        ...
        <div>
            <img src="/public/img/IMG_20260505_092432-removebg-preview.png" alt="photo profile" className="max-w-full mx-auto"/>
            <span className="absolute bottom-0 -z-10 left-1/2 -translate-x-1/2 translate-y-20">
